...
public class MemoryAccess {
	...
	public void performMA()
	{
		...
		else if(EX_MA_Latch.ins == "store")
		{
			...
			containingProcessor.getMainMemory().setWord(EX_MA_Latch.memAdd, regs.getValue(EX_MA_Latch.rs));
			System.out.println("Storing " + regs.getValue(EX_MA_Latch.rs) + " in " + EX_MA_Latch.memAdd);
		}
